...
model_new <- lm(formula = percent_commuting_msa ~ per_capita_vrh, data = nicole_df)
ggplot(nicole_df, aes(x = per_capita_vrh, y = percent_commuting_msa)) + geom_point() + geom_smooth(method = 'lm', se = F)
summary(model_new)
```
