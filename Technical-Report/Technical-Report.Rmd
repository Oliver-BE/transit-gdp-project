...
ggplot(final_df, aes(x = percent_commuting_msa, y = per_capita_gdp)) +
  ...
  labs(x = "Percent Workers Commuting to Work by Public Transit", y = "GDP per Capita", title = "Percent Workers Commuting to Work
...
kable(head(arrange(final_model, desc(as.numeric(R2))), caption="Final Models, Arranged by MAE"), n=6)
