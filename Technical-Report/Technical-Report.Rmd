...
Creates and tidies dataframe for each transit variable (UPT, VRM, VRH, DRM, PMT, expenses, and fares).
```{r, messages=FALSE}
...
This convert our final data frame into a CSV as well as saving it as a reactive data structure (RDS). 
```{r, messages = FALSE}
