...
pmt_fta_df <- new_clean_fta_df(13, "pmt") %>% 
  group_by(UZA, Year, modes_clean) %>% 
...
master_fta_df <- read_xlsx("FTA-data/FTA-dataframes/FTA_September_2018.xlsx", sheet=2, range="A1:Y2129", col_names=TRUE) %>% 
  ...
  select(UZA, `UZA Area SQ Miles`, UZA_Pop_2010, `Service Area SQ Miles`, `Service Area Population`, `Passenger Miles FY`, `Unlinked Passenger Trips FY`, `Fares FY`, `Operating Expenses FY`)
```
