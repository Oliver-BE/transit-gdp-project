...
primary_variable_fta_df <- 
  ...
  inner_join(new_vrh_fta_df,  by= c("UZA", "UZA Name", "Year", "modes_clean")) %>% 
  inner_join(new_vrm_fta_df,  by= c("UZA", "UZA Name", "Year", "modes_clean")) %>% 
  inner_join(pmt_fta_df,      by= c("UZA", "UZA Name", "Year", "modes_clean")) %>%
  inner_join(new_upt_fta_df,  by= c("UZA", "UZA Name", "Year", "modes_clean")) %>% 
  unique()
...
### Read in Master FTA Dataframe to use a
...
fta_df <- left_join(primary_variable_fta_df, transit_stations_df, by = c("UZA", "modes_clean"))%>%
